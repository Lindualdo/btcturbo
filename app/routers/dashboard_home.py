...
def calcular_dashboard_home():
    ...
    """
    try:
        logger.info("🚀 REFATORADO: Calculando dashboard modular (FASE 3)...")
        ...
        return {
            ...
            "message": "Dashboard calculado e gravado (FASE 3 - header + mercado + risco)"
        }
...
def debug_dashboard_home():
    ...
    try:
        ...
        return {
            ...
            "arquitetura": {
                "helpers": ["header_helper", "mercado_helper", "risco_helper"],
