...
def _get_risco_data() -> Dict:
    ...
    try:
        ...
        return {
            ...
            "position_usd": _extract_monetary(dados_riscos["posicao_atual"]["posicao_total"]["valor_formatado"]),
            "divida_total": _extract_monetary(dados_riscos["posicao_atual"]["divida_total"]["valor_formatado"])
