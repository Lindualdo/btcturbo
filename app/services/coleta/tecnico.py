...
from .tecnico_v3.utils.score_compositor import calcular_score_tecnico_v3
...
def coletar(forcar_coleta: bool):
    ...
    try:
        ...
        dados_para_db = {
            ...
            # Scores consolidados por componente
            "score_alinhamento_consolidado": (
                resultado_v3["timeframes"]["semanal"]["alinhamento"]["score"] * 0.7 +
                resultado_v3["timeframes"]["diario"]["alinhamento"]["score"] * 0.3
            ),
            "score_expansao_consolidado": (
                resultado_v3["timeframes"]["semanal"]["expansao"]["score"] * 0.7 +
                resultado_v3["timeframes"]["diario"]["expansao"]["score"] * 0.3
            ),
